...
\begin{frame}
    ...
    \begin{block}{Fonctionnalités}
      \begin{itemize}
        ...
        \item Visualisation des commandes nécessaire pour chaque action.
      \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Gestion d'un trousseau de clés gpg}
      \begin{itemize}
        \item Création de clés / sous clé.
...
\begin{frame}
  \frametitle{\color{white}Attaque}
  \begin{block}{ }
  Le but de cette attaque est de trouver une seconde clef possédant le même KeyId que la première. Cette attaque est issue du dépôt github de Jameson
  ...
  \subsection{Risques techniques}
    \begin{frame}
      ...
      \begin{block}{Maîtrise des outils}
        Majorité des membres pas assez formée sur les outils utilisés\\
        (git, Qt, C++, gpg)
      \end{block}
      \pause
      \begin{exampleblock}{Solutions}
    ...
    \begin{frame}
      ...
      \begin{block}{Fonctionnement technique de GnuPG}
        \begin{itemize}
          ...
          \item Complication de la tâche pour arriver à envoyer et récupérer des données du logiciel.
        \end{itemize}
      ...
      \begin{alertblock}{Impacts}
        \begin{itemize}
          ...
          \item L'utilisation de bibliothèques nous aurait fait perdre
