...
\section{Bilan du projet}
  ...
  \begin{frame}
    \frametitle{\color{white}Besoin négocié}
    \begin{block}{Ce qui a été supprimé du besoin initial}
      \begin{itemize}
        \item 
        \item 
        \item 
  ...
  \begin{frame}
    \frametitle{\color{white}Objets validés}
    \begin{block}{Ce qui a été validé}
      \begin{itemize}
        \item 
        \item 
        \item 
      \end{itemize}
    \end{block}
    \begin{block}{Ce qui n'a pas été validé}
      \begin{itemize}
        \item 
        \item 
        \item 
