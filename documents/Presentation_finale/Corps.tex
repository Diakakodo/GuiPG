...
\begin{frame}
  ...
  Cette attaque est issue du dépôt github de Micah Lee (trollwot), lui même issue du code source du projet Monkeysphere.
  \end{block}
  ...
  \subsection{Risques organisationnels}
	...
	\end{itemize}
      ...
      \begin{exampleblock}{Plan d'action}
        \begin{itemize}
          \item Réunion pour effectuer l'état d'avancement du projet.
