...
Chaque procédure de test devra être réalisée sous Gnome et sous KDE. La compatibilité Windows est optionnelle.
...
\begin{center}
    \begin{tabular}{|p{2.8cm}|p{4.2cm}|p{3cm}|p{5cm}|}
      ...
      EF\_01 & La commande demandée a été exécutée avec les bons paramètres. &  & \\ \hline
      EF\_02 & Le chiffrement - déchiffrement - signature - vérification a été exécuté avec les bons paramètres. &  & \\ \hline
      EF\_03 & Chaque commande effectuée est affichée, avec retours et erreurs. &  & \\ \hline
      EF\_04 & Le formulaire de sélection de profil fonctionne. &  & \\ \hline
      EF\_05 & Tout changement de confiance est répercuté sur la toile de confiance. &  & \\ \hline
      EF\_06 & La clé produite a le même KeyID que celle donnée &  & \\ \hline
      EO\_01 & Effectuer tous les tests sous l'interface KDE. &  & \\ \hline
      EO\_02 & Effectuer tous les tests sous l'interface Gnome. &  & \\ \hline
      EO\_03 & Effectuer tous les tests sous Windows. &  & \\ \hline
      EO\_05 & Ouvrir deux interfaces avec deux profils différents &  & \\ \hline
      EO\_06 & Tester si on peut s'authentifier en SSH par clé PGP. &  & \\ \hline
      EI\_01 & Effectuer tous les tests avec GnuPG 2.0.26. &  & \\ \hline 
      EI\_02 & Effectuer tous les tests avec GnuPG 2.0.26. &  & \\ \hline
      EQ\_01 & Chaque niveau de confiance est représenté par une couleur. &  & \\ \hline
      EQ\_03 & Effectuer tous les tests avec le paquet fourni. &  & \\ \hline
  \end{tabular}  
\end{center}
