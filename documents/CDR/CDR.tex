...
\histentry{0.5}{15/12/2014}{Respect de la STB 0.4 et ajout des données de test.}
...
\begin{center}
    \begin{tabular}{|p{2.8cm}|p{4.2cm}|p{3cm}|p{5cm}|}
      ...
      EF\_06 & Pour une clé pgp donnée, on peut produire une autre clé ayant la même KeyID. & 3 & \\ \hline
