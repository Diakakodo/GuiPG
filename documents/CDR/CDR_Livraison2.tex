...
\subsection{Tests unitaires}
 ...
 %---------------------------------------Test N° U2------------------------------------------------------------------------------
    \begin{tabular}{|c|p{5cm}|p{5cm}|p{1.5cm}|p{1.5cm}|}
      ...
      8 & Utiliser la fonction getPrimarySecKey & La fonction renvoie la PrimarySecKey donnée à la fonction setPrimaryPubKey &  & \\
      9 & Utiliser la fonction addSubSecKey &  &  & \\
      10 & Utiliser la fonction getSubSecKeyList & La fonction renvoie une liste de SubSecKey contenant celle donnée à la fonction précédente &  & \\
	\hline
    \end{tabular}
    \vskip 2.2cm
...
\subsection{Tests d'intégration}
 ...
 %---------------------------------------Test N° I12------------------------------------------------------------------------------
    \begin{tabular}{|c|p{5cm}|p{5cm}|p{1.5cm}|p{1.5cm}|}
      ...
      \multicolumn{1}{c|}{Exigence} & \multicolumn{1}{c|}{OK/KO}\\ \hline
      1 & Lancer GuiPG &  &  & NOK \\
      2 & Faire une action nécessitant le lancement d'une commande GPG & La commande et les retours sont affichés dans la zoen prévue à cet effet &  & NOK \\
      3 &  &  &  & \\ 
      4 &  &  &  & \\
      5 &  &  &  & \\
      6 &  &  &  & \\
