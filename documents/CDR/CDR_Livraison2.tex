...
\begin{center}
 ...
 %---------------------------------------Test N° U4------------------------------------------------------------------------------
    \begin{tabular}{|c|p{5cm}|p{5cm}|p{1.5cm}|p{1.5cm}|}
      \hline
      \multicolumn{3}{|l|}{Objet testé : Changement de la confiance} & \multicolumn{2}{c|}{Version : 0.5}\\ \hline
      \multicolumn{5}{|l|}{Objectif de test : Changement de la confiance}\\ \hline
      \multicolumn{3}{|l|}{Procédure n° U4} & \multicolumn{2}{p{3cm}|}{Pré-requis : }\\ \hline
      \multicolumn{1}{|c|}{N°} & \multicolumn{1}{c|}{Actions} & \multicolumn{1}{c|}{Résultats attendus} & 
      \multicolumn{1}{c|}{Exigence} & \multicolumn{1}{c|}{OK/KO}\\ \hline
      1 & Changer la confiance d'une clé & La confiance a changé &  & NOK \\
      2 &  &  &  & \\
      3 &  &  &  & \\
      4 &  &  &  & \\
      5 &  &  &  & \\
...
\subsection{Tests d'intégration}
 ...
 %---------------------------------------Test N° I8------------------------------------------------------------------------------
    \begin{tabular}{|c|p{5cm}|p{5cm}|p{1.5cm}|p{1.5cm}|}
      ...
      \multicolumn{1}{c|}{Exigence} & \multicolumn{1}{c|}{OK/KO}\\ \hline
      1 & Lancer GuiPG &  &  & OK \\
      2 & Ouvrir le menu de création de clé & Le menu s'affiche &  & \\
      3 & Ecrire quelque chose dans les champs de la passphrase & La passphrase n'est pas affichée en clair &  & \\ 
      4 &  &  &  & \\
      5 &  &  &  & \\
      6 &  &  &  & \\
      7 &  &  &  & \\
