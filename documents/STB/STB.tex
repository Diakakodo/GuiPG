...
Ce document est la Spécification Technique du Besoin pour le projet PGP.

\subsection{Besoins opérationnels}
Les besoins opérationnels de l'interface graphique du logiciel GnuPG sont :
\begin{itemize}
...
Les objectifs techniques de l'interface graphique du logiciel GnuPG sont :
\begin{itemize}
