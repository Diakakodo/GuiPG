...
{Utilisateur}
% Description
{Modification de la Toile de confiance, par un changement de niveau de confiance, l'ajout d'une nouvelle clé ou la modification d'une clé, via l'interface de GnuPG
uniquement }
% Préconditions
