...
Il est ensuite demandé de proposer une interface graphique pour GnuPG, accompagnée d'un document d'explications et de recommandations pour l'utilisation.
...
% Préconditions
{
  ...
  \begin{itemize}
    ...
    \item Pour vérifier, l'utilisateur possède la clé public de l'émetteur.
  \end{itemize}
}
% Evénements déclenchants
